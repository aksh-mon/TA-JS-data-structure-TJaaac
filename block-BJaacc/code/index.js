...
// 10. Check the length of object named `students`.
 var size = Object.keys(students).length;
 console.log(size);
// 11. Can you define a key of `let or var` in any object? Reason.
 // yes we can define `let or var` inside any object because an object contain collection of keys and values
// an as key is of string type so we can put any name number inside the object. 
