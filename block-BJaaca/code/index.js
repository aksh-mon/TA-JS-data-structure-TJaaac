...
// character.greet = function gkey(){ alert ` I am Arya and my title is Lady of winterfall`};
...
character.isAdult = function changeIsAdult(){age < 18 || age > 18};
