...
console.log(user[0].genres[0]);
console.log(user[0].genres[1]);
console.log(user[0].genres[2]);

for(let use of user) {
  for (let genre of use.genres){
    console.log(genre);
  }
}
for(let use of user) {
